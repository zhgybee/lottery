...
$(function() 
{
    ...
    try 
	{
        var pnp = new SoftKey3W();
        pnp.Socket_UK.onopen = function() 
		{
            pnp.ResetOrder()
        };
        pnp.Socket_UK.onmessage = function(Msg) 
		{
			...
			else if(UK_Data.order == 1)
			{
				if (UK_Data.LastError != 0) 
				{
					alert("未发现加密狗，请插入加密狗重新登陆");
					pnp.Socket_UK.close();
        ...
        pnp.Socket_UK.onclose = function() {console.log('close');}
    } 
	catch (e) 
	{
