	...
	<div class="sub-module" id="analysis-panel">
		...
		<div class="clearfix" style="overflow:hidden">
			<div class="left" style="width:50%; padding:20px; box-sizing:border-box">
				<p>1、请选择生成组码的地方台彩票。</p>
				<p>2、点击计算按钮生成号码组</p>
				<input id="11x5-type" class="lottery-type-field" style="width:100%" value="ah11x5" title="安徽11选5"/>
				...
				<p id="resource-panel" style="margin-top:10px; color:#ff6600"></p>
			</div>
		...
		$("#starting-button").on("click", function()
		{
			...
			$.post("service/recgroup.jsp", parameter, function(response)
			{
				...
				if(response.status == 1)
				{
					...
					$("#resource-panel").html("大等于3期不中出数共"+response.resource.gt3count+"，占比"+proportion+"%。");
				}
				else
				{
