	...
	<div class="sub-module chart-module">
		...
		<div id="chart-panel">
			...
			<div id="chart-buttons">
				...
				<a class="button lottery-disabled-button" href="5.jsp" target="_blank">奇偶走势图</a>
			...
			<div id="detailed-panel">
				<table>
					...
					<tr>
						...
						<th colspan="6" style="width:180px">奇偶比走势</th>
					</tr>
					<tr>
						<th>01</th>
						<th>02</th>
	...
	<script type="text/javascript">
		...
		$(function()
		{
			...
			({
				...
				clickitem:function()
				{
					window.location.href = '5.jsp?type='+$("#11x5-type").val()+'&length='+$("#11x5-length").val();
				}
			});
