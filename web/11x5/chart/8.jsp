...
<head>
	...
	<style>
	td{font-size:15px}
	#chart-panel table .c1{background-color:#ffffff; color:#eeeeee; width:38px; height:38px; line-height:38px; display:block; text-align:center; box-sizing:border-box; padding-top:0px; margin-left:1px}
	#chart-panel table .c2{background-color:#eeeeee; color:#aaaaaa; width:38px; height:38px; line-height:38px; display:block; text-align:center; box-sizing:border-box; padding-top:0px; margin-left:1px}
	...
	#chart-panel table .c4{background-color:#f5cc7d; color:#f1f1f1; width:38px; height:38px; line-height:38px; display:block; text-align:center; box-sizing:border-box; padding-top:0px; margin-left:1px}
	#chart-panel table .c5{background-color:#b01616; color:#f1f1f1; width:38px; height:38px; line-height:38px; display:block; text-align:center; box-sizing:border-box; padding-top:0px; margin-left:1px}
	...
	<div class="sub-module chart-module">		
		<div id="chart-panel">
			...
			<div id="chart-buttons">
				...
				<a class="button lottery-disabled-button" href="8.jsp" target="_blank">热码走势图</a>
